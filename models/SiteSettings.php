...
class SiteSettings {
    ...
    private function ensureSettingsColumns() {
        ...
        $columns = [
            ...
            'frontend_default_language' => "ALTER TABLE site_settings ADD COLUMN frontend_default_language VARCHAR(10) NOT NULL DEFAULT 'PL_pl'",
            'admin_default_language' => "ALTER TABLE site_settings ADD COLUMN admin_default_language VARCHAR(10) NOT NULL DEFAULT 'PL_pl'",
    ...
    private function createDefaultSettings() {
        ...
        $sql = "INSERT INTO site_settings
                    (title, logo, categories, meta_description, meta_keywords, max_ads, promotion_fee,
                     ...
                     business_hours, default_language, frontend_default_language, admin_default_language, layout_variant, company_name, company_tax_id,
    ...
    public function updateSettings($data) {
        $sql = "UPDATE site_settings SET
                ...
                frontend_default_language = :frontend_default_language,
                admin_default_language = :admin_default_language,
